...
{
    internal class UserRoleCrud1 : CRUD1Base<DTO.UserRole, TblUserRole, int>
    {
        protected override int GetLastCreatedId() { return _lastCreatedItem.Id;  }
        protected override void InsertIdInDTO(DTO.UserRole dtoItem, int idValue) { dtoItem.Id = idValue; }
        protected override int GetIdFromDTO(DTO.UserRole dtoItem) { return dtoItem.Id; }
        protected override List<int> GetIdListFromDTOList(List<DTO.UserRole> dtoList) { return dtoList.Select( x => x.Id ).ToList(); }
